...
## Summary
- 1369 nodes · 4913 edges · 59 communities (40 shown, 19 thin omitted)
...
Cohesion: 0.13
Nodes (5): Contract, EthHtlc, JSONObject, JSONObject, ConfirmCb
...
### Community 31 - ".allSwaps"
Cohesion: 0.18
Nodes (3): ClaimDeepDiscoveryTest, JSONObject, RefundRetryTest
...
- **Why does `MainActivity` connect `MainActivity` to `MinimaHtlc`, `Order`, `OtcController`, `PriceOracle`, `android.content.SharedPreferences`, `EthRpc`, `CommsScanner`, `SendCb`, `SwapDb`, `IdentityWatch`, `EthWallet`, `.compareForFill`, `org.junit.Before`, `.reportInspection`, `NodeApi`, `SwapEngine`, `OtcOffer`, `org.json.JSONObject`, `Override`, `.startLeg`, `CryptoProvider`, `com.goterl.lazysodium.LazySodium`?**
  _High betweenness centrality (0.254) - this node is a cross-community bridge._
- **Why does `SwapEngine` connect `SwapEngine` to `MinimaHtlc`, `Order`, `OtcController`, `MainActivity`, `EthRpc`, `AtomiX Full Security & Code Review Report`, `SwapService`, `GateTest`, `SendCb`, `SwapDb`, `IdentityWatch`, `EthWallet`, `EthHtlc`, `org.junit.Before`, `.reportInspection`, `NodeApi`, `.allSwaps`, `.checkCanSwapCoin`, `org.json.JSONObject`, `Override`, `.startLeg`, `SwapEngine.java`, `.checkEthContractFor`, `.checkLadderCoins`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `MinimaHtlc` connect `MinimaHtlc` to `OtcController`, `android.content.SharedPreferences`, `MainActivity`, `HtlcTxnConstructionTest`, `SwapService`, `GateTest`, `.claim`, `SwapDb`, `IdentityWatch`, `EthWallet`, `.reportInspection`, `NodeApi`, `SwapEngine`, `.allSwaps`, `.checkCanSwapCoin`, `org.json.JSONObject`, `.startLeg`, `org.junit.Test`, `IdentityBlockTest`, `SwapEngine.java`, `.checkEthContractFor`, `.checkLadderCoins`?**
