 ...
 * SwapService live in one process and share this static state plus the "atomix" prefs keys below.
 */
public final class PriceOracle {
    ...
    /** Hand the oracle the shared "atomix" prefs and restore the persisted last-good stamp, so the
